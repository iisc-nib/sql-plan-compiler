...
count_616d1c10f740<<<std::ceil((float)lineorder_size/128.), 128>>>(d_BUF_616d1c12c6b0, d_BUF_616d1c12d0d0, d_BUF_616d1c12d190, d_HT_616d1c0df300.ref(cuco::insert), d_HT_616d1c12c6b0.ref(cuco::for_each), d_HT_616d1c12d0d0.ref(cuco::for_each), d_HT_616d1c12d190.ref(cuco::for_each), d_customer__c_city_encoded, d_date__d_year, d_lineorder__lo_custkey, d_lineorder__lo_orderdate, d_lineorder__lo_suppkey, lineorder_size, d_supplier__s_city_encoded);
...
main_616d1c10f740<<<std::ceil((float)lineorder_size/128.), 128>>>(d_BUF_616d1c12c6b0, d_BUF_616d1c12d0d0, d_BUF_616d1c12d190, d_HT_616d1c0df300.ref(cuco::find), d_HT_616d1c12c6b0.ref(cuco::for_each), d_HT_616d1c12d0d0.ref(cuco::for_each), d_HT_616d1c12d190.ref(cuco::for_each), d_KEY_616d1c0df300customer__c_city_encoded, d_KEY_616d1c0df300date__d_year, d_KEY_616d1c0df300supplier__s_city_encoded, d_aggr0__tmp_attr0, d_customer__c_city_encoded, d_date__d_year, d_lineorder__lo_custkey, d_lineorder__lo_orderdate, d_lineorder__lo_revenue, d_lineorder__lo_suppkey, lineorder_size, d_supplier__s_city_encoded);
//Materialize count
