...
count_5b6bc68d8c80<<<std::ceil((float)customer_size/128.), 128>>>(d_COUNT5b6bc68f76e0, d_customer__c_city, customer_size);
...
main_5b6bc68d8c80<<<std::ceil((float)customer_size/128.), 128>>>(d_BUF_5b6bc68f76e0, d_BUF_IDX_5b6bc68f76e0, d_HT_5b6bc68f76e0.ref(cuco::insert), d_customer__c_city, d_customer__c_custkey, customer_size);
//Materialize count
...
count_5b6bc68d9220<<<std::ceil((float)supplier_size/128.), 128>>>(d_COUNT5b6bc68f23e0, d_supplier__s_city, supplier_size);
...
main_5b6bc68d9220<<<std::ceil((float)supplier_size/128.), 128>>>(d_BUF_5b6bc68f23e0, d_BUF_IDX_5b6bc68f23e0, d_HT_5b6bc68f23e0.ref(cuco::insert), d_supplier__s_city, d_supplier__s_suppkey, supplier_size);
//Materialize count
...
count_5b6bc69051d0<<<std::ceil((float)date_size/128.), 128>>>(d_COUNT5b6bc68f8450, d_date__d_yearmonth, date_size);
...
main_5b6bc69051d0<<<std::ceil((float)date_size/128.), 128>>>(d_BUF_5b6bc68f8450, d_BUF_IDX_5b6bc68f8450, d_HT_5b6bc68f8450.ref(cuco::insert), d_date__d_datekey, d_date__d_yearmonth, date_size);
//Create aggregation hash table
...
insertKeys<<<std::ceil((float)COUNT5b6bc68a90f0/128.), 128>>>(raw_keys5b6bc68a90f0, d_HT_5b6bc68a90f0.ref(cuco::insert), COUNT5b6bc68a90f0);
//Aggregate in hashtable
...
count_5b6bc69126d0<<<std::ceil((float)COUNT5b6bc68a90f0/128.), 128>>>(COUNT5b6bc68a90f0, d_COUNT5b6bc68bc240);
...
main_5b6bc69126d0<<<std::ceil((float)COUNT5b6bc68a90f0/128.), 128>>>(COUNT5b6bc68a90f0, d_MAT5b6bc68bc240aggr0__tmp_attr0, d_MAT5b6bc68bc240customer__c_city_encoded, d_MAT5b6bc68bc240date__d_year, d_MAT5b6bc68bc240supplier__s_city_encoded, d_MAT_IDX5b6bc68bc240, d_aggr0__tmp_attr0, d_KEY_5b6bc68a90f0customer__c_city_encoded, d_KEY_5b6bc68a90f0date__d_year, d_KEY_5b6bc68a90f0supplier__s_city_encoded);
