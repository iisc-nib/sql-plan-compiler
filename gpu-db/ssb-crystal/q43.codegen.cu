...
count_5999e9966490<<<std::ceil((float)supplier_size/128.), 128>>>(d_COUNT5999e9959fb0, d_supplier__s_nation, supplier_size);
...
main_5999e9966490<<<std::ceil((float)supplier_size/128.), 128>>>(d_BUF_5999e9959fb0, d_BUF_IDX_5999e9959fb0, d_HT_5999e9959fb0.ref(cuco::insert), d_supplier__s_nation, d_supplier__s_suppkey, supplier_size);
//Materialize count
...
count_5999e9968e50<<<std::ceil((float)part_size/128.), 128>>>(d_COUNT5999e995a920, d_part__p_category, part_size);
...
main_5999e9968e50<<<std::ceil((float)part_size/128.), 128>>>(d_BUF_5999e995a920, d_BUF_IDX_5999e995a920, d_HT_5999e995a920.ref(cuco::insert), d_part__p_category, d_part__p_partkey, part_size);
//Materialize count
...
count_5999e98ff9f0<<<std::ceil((float)date_size/128.), 128>>>(d_COUNT5999e9956460, d_date__d_year, date_size);
...
main_5999e98ff9f0<<<std::ceil((float)date_size/128.), 128>>>(d_BUF_5999e9956460, d_BUF_IDX_5999e9956460, d_HT_5999e9956460.ref(cuco::insert), d_date__d_datekey, d_date__d_year, date_size);
//Materialize count
...
count_5999e98ff7b0<<<std::ceil((float)customer_size/128.), 128>>>(d_BUF_5999e9938850, d_HT_5999e990db50.ref(cuco::insert), d_HT_5999e9938850.ref(cuco::for_each), d_customer__c_custkey, customer_size, d_date__d_year, d_part__p_brand1_encoded, d_supplier__s_city_encoded);
...
insertKeys<<<std::ceil((float)COUNT5999e990db50/128.), 128>>>(raw_keys5999e990db50, d_HT_5999e990db50.ref(cuco::insert), COUNT5999e990db50);
//Aggregate in hashtable
...
count_5999e9984120<<<std::ceil((float)COUNT5999e990db50/128.), 128>>>(d_COUNT5999e98ede30, COUNT5999e990db50);
