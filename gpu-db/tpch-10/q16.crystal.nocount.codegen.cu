...
main_1<<<std::ceil((float)part_size/(float)TILE_SIZE), TB>>>(d_BUF_0, d_BUF_IDX_0, d_HT_0.ref(cuco::insert), d_part__p_brand, d_part__p_partkey, d_part__p_size, d_part__p_type, part_size);
...
main_3<<<std::ceil((float)supplier_size/(float)TILE_SIZE), TB>>>(d_HT_2.ref(cuco::insert), d_supplier__s_comment, d_supplier__s_suppkey, supplier_size);
size_t COUNT4 = 1303414;
...
main_7<<<std::ceil((float)COUNT4/(float)TILE_SIZE), TB>>>(COUNT4, d_MAT6aggr0__tmp_attr0, d_MAT6part__p_brand_encoded, d_MAT6part__p_size, d_MAT6part__p_type_encoded, d_MAT_IDX6, d_aggr0__tmp_attr0, d_KEY_4part__p_brand_encoded, d_KEY_4part__p_size, d_KEY_4part__p_type_encoded);
