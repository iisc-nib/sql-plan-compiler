...
main_1<<<std::ceil((float)lineitem_size/(float)TILE_SIZE), TB>>>(d_HT_0.ref(cuco::insert_and_find), d_KEY_0lineitem__l_linestatus, d_KEY_0lineitem__l_returnflag, d_SLOT_COUNT_0, d_aggr0__tmp_attr0, d_aggr0__tmp_attr1, d_aggr0__tmp_attr2, d_aggr0__tmp_attr4, d_aggr0__tmp_attr9, d_aggr_rw__rw0, d_aggr_rw__rw1, d_aggr_rw__rw2, d_aggr_rw__rw3, d_aggr_rw__rw4, d_aggr_rw__rw5, d_lineitem__l_discount, d_lineitem__l_extendedprice, d_lineitem__l_linestatus, d_lineitem__l_quantity, d_lineitem__l_returnflag, d_lineitem__l_shipdate, d_lineitem__l_tax, lineitem_size);
COUNT0 = d_HT_0.size();
...
main_3<<<std::ceil((float)COUNT0/(float)TILE_SIZE), TB>>>(COUNT0, d_MAT2aggr0__tmp_attr0, d_MAT2aggr0__tmp_attr1, d_MAT2aggr0__tmp_attr2, d_MAT2aggr0__tmp_attr4, d_MAT2aggr0__tmp_attr6, d_MAT2aggr0__tmp_attr7, d_MAT2aggr0__tmp_attr8, d_MAT2aggr0__tmp_attr9, d_MAT2lineitem__l_linestatus, d_MAT2lineitem__l_returnflag, d_MAT_IDX2, d_aggr0__tmp_attr0, d_aggr0__tmp_attr1, d_aggr0__tmp_attr2, d_aggr0__tmp_attr4, d_aggr0__tmp_attr9, d_aggr_rw__rw0, d_aggr_rw__rw1, d_aggr_rw__rw2, d_aggr_rw__rw3, d_aggr_rw__rw4, d_aggr_rw__rw5, d_KEY_0lineitem__l_linestatus, d_KEY_0lineitem__l_returnflag);
uint64_t MATCOUNT_2 = 0;
cudaMemcpy(&MATCOUNT_2, d_MAT_IDX2, sizeof(uint64_t), cudaMemcpyDeviceToHost);
...
for (auto i=0ull; i < MATCOUNT_2; i++) { std::cout << "" << MAT2lineitem__l_returnflag[i];
