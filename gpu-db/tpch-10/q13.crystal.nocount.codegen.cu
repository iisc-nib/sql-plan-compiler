...
main_1<<<std::ceil((float)customer_size/(float)TILE_SIZE), TB>>>(d_BUF_0, d_BUF_IDX_0, d_HT_0.ref(cuco::insert), d_customer__c_custkey, customer_size);
...
main_3<<<std::ceil((float)orders_size/(float)TILE_SIZE), TB>>>(d_BUF_0, d_HT_0.ref(cuco::find), d_HT_2.ref(cuco::insert_and_find), d_KEY_2customer__c_custkey, d_SLOT_COUNT_2, d_aggr0__tmp_attr0, d_customer__c_custkey, d_orders__o_custkey, d_orders__o_orderkey, orders_size);
COUNT2 = d_HT_2.size();
...
main_5<<<std::ceil((float)COUNT2/(float)TILE_SIZE), TB>>>(COUNT2, d_HT_4.ref(cuco::insert_and_find), d_KEY_4aggr0__tmp_attr0, d_SLOT_COUNT_4, d_aggr0__tmp_attr0, d_aggr1__tmp_attr1);
COUNT4 = d_HT_4.size();
...
main_7<<<std::ceil((float)COUNT4/(float)TILE_SIZE), TB>>>(COUNT4, d_MAT6aggr0__tmp_attr0, d_MAT6aggr1__tmp_attr1, d_MAT_IDX6, d_KEY_4aggr0__tmp_attr0, d_aggr1__tmp_attr1);
