...
main_1<<<std::ceil((float)orders_size/(float)TILE_SIZE), TB>>>(d_BUF_0, d_BUF_IDX_0, d_HT_0.ref(cuco::insert), d_orders__o_orderkey, orders_size);
size_t COUNT2 = 292901;
...
main_5<<<std::ceil((float)COUNT2/(float)TILE_SIZE), TB>>>(COUNT2, d_MAT4aggr0__tmp_attr0, d_MAT4aggr0__tmp_attr2, d_MAT4lineitem__l_shipmode_encoded, d_MAT_IDX4, d_aggr0__tmp_attr0, d_aggr0__tmp_attr2, d_KEY_2lineitem__l_shipmode_encoded);
