...
main_1<<<std::ceil((float)lineitem_size/(float)TILE_SIZE), TB>>>(d_HT_0.ref(cuco::insert_and_find), d_SLOT_COUNT_0, d_aggr0__tmp_attr0, d_lineitem__l_discount, d_lineitem__l_extendedprice, d_lineitem__l_quantity, d_lineitem__l_shipdate, lineitem_size);
COUNT0 = d_HT_0.size();
...
main_3<<<std::ceil((float)COUNT0/(float)TILE_SIZE), TB>>>(COUNT0, d_MAT2aggr0__tmp_attr0, d_MAT_IDX2, d_aggr0__tmp_attr0);
