...
__global__ void count_1(uint64_t* COUNT6, DBStringType* part__p_brand, DBI32Type* part__p_size, DBStringType* part__p_type, size_t part_size) {
...
__global__ void count_5(uint64_t* COUNT8, DBStringType* supplier__s_comment, size_t supplier_size) {
size_t tile_offset = blockIdx.x * TILE_SIZE;
size_t tid = tile_offset + threadIdx.x;
int selection_flags[ITEMS_PER_THREAD];
for (int i=0; i<ITEMS_PER_THREAD; i++) selection_flags[i] = 1;
...
template<typename HASHTABLE_PROBE, typename HASHTABLE_PROBE_SJ, typename HASHTABLE_INSERT>
__global__ void count_7(uint64_t* BUF_6, HASHTABLE_PROBE HT_6, HASHTABLE_PROBE_SJ HT_8, HASHTABLE_INSERT HT_9, DBI16Type* part__p_brand_encoded, DBI32Type* part__p_size, DBI16Type* part__p_type_encoded, DBI32Type* partsupp__ps_partkey, DBI32Type* partsupp__ps_suppkey, size_t partsupp_size) {
size_t tile_offset = blockIdx.x * TILE_SIZE;
size_t tid = tile_offset + threadIdx.x;
int selection_flags[ITEMS_PER_THREAD];
for (int i=0; i<ITEMS_PER_THREAD; i++) selection_flags[i] = 1;
...
__global__ void main_7(uint64_t* BUF_6, HASHTABLE_PROBE HT_6, HASHTABLE_PROBE_SJ HT_8, HASHTABLE_FIND HT_9, DBI16Type* KEY_9part__p_brand_encoded, DBI32Type* KEY_9part__p_size, DBI16Type* KEY_9part__p_type_encoded, DBI64Type* aggr0__tmp_attr0, int64_t* cycles_per_warp_main_7_aggregation_9, int64_t* cycles_per_warp_main_7_anti_semi_join_probe_8, int64_t* cycles_per_warp_main_7_join_probe_6, DBI16Type* part__p_brand_encoded, DBI32Type* part__p_size, DBI16Type* part__p_type_encoded, DBI32Type* partsupp__ps_partkey, DBI32Type* partsupp__ps_suppkey, size_t partsupp_size) {
int64_t start, stop, cycles_per_warp;
size_t tile_offset = blockIdx.x * TILE_SIZE;
size_t tid = tile_offset + threadIdx.x;
int selection_flags[ITEMS_PER_THREAD];
...
count_1<<<std::ceil((float)part_size/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(d_COUNT6, d_part__p_brand, d_part__p_size, d_part__p_type, part_size);
uint64_t COUNT6;
...
count_5<<<std::ceil((float)supplier_size/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(d_COUNT8, d_supplier__s_comment, supplier_size);
uint64_t COUNT8;
...
main_5<<<std::ceil((float)supplier_size/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(d_HT_8.ref(cuco::insert), d_cycles_per_warp_main_5_anti_semi_join_build_8, d_cycles_per_warp_main_5_selection_4, d_supplier__s_comment, d_supplier__s_suppkey, supplier_size);
...
count_7<<<std::ceil((float)partsupp_size/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(d_BUF_6, d_HT_6.ref(cuco::find), d_HT_8.ref(cuco::find), d_HT_9.ref(cuco::insert), d_part__p_brand_encoded, d_part__p_size, d_part__p_type_encoded, d_partsupp__ps_partkey, d_partsupp__ps_suppkey, partsupp_size);
...
main_11<<<std::ceil((float)COUNT9/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(COUNT9, d_MAT10aggr0__tmp_attr0, d_MAT10part__p_brand_encoded, d_MAT10part__p_size, d_MAT10part__p_type_encoded, d_MAT_IDX10, d_aggr0__tmp_attr0, d_cycles_per_warp_main_11_materialize_10, d_KEY_9part__p_brand_encoded, d_KEY_9part__p_size, d_KEY_9part__p_type_encoded);
