...
main_1<<<std::ceil((float)lineitem_size/(float)TILE_SIZE), TB>>>(d_BUF_5, d_HT_5.ref(cuco::find), d_HT_9.ref(cuco::insert_and_find), d_KEY_9lineitem__l_shipmode_encoded, d_SLOT_COUNT_9, d_aggr0__tmp_attr0, d_aggr0__tmp_attr2, d_cycles_per_warp_main_1_aggregation_9, d_cycles_per_warp_main_1_join_probe_5, d_cycles_per_warp_main_1_map_7, d_cycles_per_warp_main_1_map_8, d_cycles_per_warp_main_1_selection_0, d_cycles_per_warp_main_1_selection_2, d_cycles_per_warp_main_1_selection_3, d_cycles_per_warp_main_1_selection_4, d_lineitem__l_commitdate, d_lineitem__l_orderkey, d_lineitem__l_receiptdate, d_lineitem__l_shipdate, d_lineitem__l_shipmode, d_lineitem__l_shipmode_encoded, lineitem_size, d_orders__o_orderpriority);
...
main_11<<<std::ceil((float)COUNT9/(float)TILE_SIZE), TB>>>(COUNT9, d_MAT10aggr0__tmp_attr0, d_MAT10aggr0__tmp_attr2, d_MAT10lineitem__l_shipmode_encoded, d_MAT_IDX10, d_aggr0__tmp_attr0, d_aggr0__tmp_attr2, d_cycles_per_warp_main_11_materialize_10, d_KEY_9lineitem__l_shipmode_encoded);
