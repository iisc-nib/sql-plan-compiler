...
__global__ void main_9(uint64_t* BUF_0, uint64_t* BUF_2, uint64_t* BUF_4, uint64_t* BUF_6, HASHTABLE_PROBE HT_0, HASHTABLE_PROBE HT_2, HASHTABLE_PROBE HT_4, HASHTABLE_PROBE HT_6, HASHTABLE_FIND HT_8, DBI32Type* KEY_8date__d_year, DBI16Type* KEY_8part__p_category_encoded, DBI16Type* KEY_8supplier__s_nation_encoded, int* SLOT_COUNT_8, DBDecimalType* aggr0__tmp_attr0, DBI32Type* date__d_year, DBI32Type* lineorder__lo_custkey, DBI32Type* lineorder__lo_orderdate, DBI32Type* lineorder__lo_partkey, DBDecimalType* lineorder__lo_revenue, DBI32Type* lineorder__lo_suppkey, DBDecimalType* lineorder__lo_supplycost, size_t lineorder_size, DBI16Type* part__p_category_encoded, DBI16Type* supplier__s_nation_encoded) {
int64_t start, stop, cycles_per_warp;
size_t tile_offset = blockIdx.x * TILE_SIZE;
size_t tid = tile_offset + threadIdx.x;
int selection_flags[ITEMS_PER_THREAD];
...
main_7<<<std::ceil((float)part_size/(float)TILE_SIZE), TB>>>(d_BUF_6, d_BUF_IDX_6, d_HT_6.ref(cuco::insert), d_part__p_mfgr, d_part__p_partkey, part_size);
...
main_11<<<std::ceil((float)COUNT8/(float)TILE_SIZE), TB>>>(COUNT8, d_MAT10aggr0__tmp_attr0, d_MAT10date__d_year, d_MAT10part__p_category_encoded, d_MAT10supplier__s_nation_encoded, d_MAT_IDX10, d_aggr0__tmp_attr0, d_KEY_8date__d_year, d_KEY_8part__p_category_encoded, d_KEY_8supplier__s_nation_encoded);
