...
main_1<<<std::ceil((float)customer_size/(float)TILE_SIZE), TB>>>(d_BUF_0, d_BUF_IDX_0, d_HT_0.ref(cuco::insert), d_customer__c_custkey, d_customer__c_region, customer_size);
...
main_3<<<std::ceil((float)supplier_size/(float)TILE_SIZE), TB>>>(d_BUF_2, d_BUF_IDX_2, d_HT_2.ref(cuco::insert), d_supplier__s_region, d_supplier__s_suppkey, supplier_size);
...
main_5<<<std::ceil((float)part_size/(float)TILE_SIZE), TB>>>(d_BUF_4, d_BUF_IDX_4, d_HT_4.ref(cuco::insert), d_part__p_mfgr, d_part__p_partkey, part_size);
...
main_7<<<std::ceil((float)date_size/(float)TILE_SIZE), TB>>>(d_BUF_6, d_BUF_IDX_6, d_HT_6.ref(cuco::insert), d_date__d_datekey, date_size);
size_t COUNT8 = 936802;
...
main_11<<<std::ceil((float)COUNT8/(float)TILE_SIZE), TB>>>(COUNT8, d_MAT10aggr0__tmp_attr0, d_MAT10customer__c_nation_encoded, d_MAT10date__d_year, d_MAT_IDX10, d_aggr0__tmp_attr0, d_KEY_8customer__c_nation_encoded, d_KEY_8date__d_year);
