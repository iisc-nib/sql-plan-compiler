...
main_1<<<std::ceil((float)part_size/(float)TILE_SIZE), TB>>>(d_BUF_0, d_BUF_IDX_0, d_HT_0.ref(cuco::insert), d_part__p_brand1, d_part__p_partkey, part_size);
...
main_5<<<std::ceil((float)date_size/(float)TILE_SIZE), TB>>>(d_BUF_4, d_BUF_IDX_4, d_HT_4.ref(cuco::insert), d_date__d_datekey, date_size);
size_t COUNT6 = 12815;
auto d_HT_6 = cuco::static_map{ (int)12815*2, cuco::empty_key{(int64_t)-1},         cuco::empty_value{(int64_t)-1},         thrust::equal_to<int64_t>{},         cuco::linear_probing<1, cuco::default_hash_function<int64_t>>() };
int* d_SLOT_COUNT_6;
...
main_9<<<std::ceil((float)COUNT6/(float)TILE_SIZE), TB>>>(COUNT6, d_MAT8aggr0__tmp_attr0, d_MAT8date__d_year, d_MAT8part__p_brand1_encoded, d_MAT_IDX8, d_aggr0__tmp_attr0, d_KEY_6date__d_year, d_KEY_6part__p_brand1_encoded);
