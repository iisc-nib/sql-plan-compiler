...
//Create aggregation hash table
auto d_HT_6 = cuco::static_map{ (int)2887*2, cuco::empty_key{(int64_t)-1},cuco::empty_value{(int64_t)-1},thrust::equal_to<int64_t>{},cuco::linear_probing<1, cuco::default_hash_function<int64_t>>() };
