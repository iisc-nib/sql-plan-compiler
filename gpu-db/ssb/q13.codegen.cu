...
main_5e8b6f444740<<<std::ceil((float)lineorder_size/32.), 32>>>(d_BUF_5e8b6f45c390, d_HT_5e8b6f4159e0.ref(cuco::find), d_HT_5e8b6f45c390.ref(cuco::for_each), d_aggr0__tmp_attr0, d_lineorder__lo_discount, d_lineorder__lo_extendedprice, d_lineorder__lo_orderdate, d_lineorder__lo_quantity, lineorder_size);
//Materialize count
