...
__global__ void count_8(uint64_t* COUNT28, DBStringType* supplier__s_nation, size_t supplier_size) {
...
__global__ void count_14(uint64_t* COUNT29, DBStringType* part__p_category, size_t part_size) {
size_t tile_offset = blockIdx.x * TILE_SIZE;
size_t tid = tile_offset + threadIdx.x;
int selection_flags[ITEMS_PER_THREAD];
for (int i=0; i<ITEMS_PER_THREAD; i++) selection_flags[i] = 1;
...
__global__ void count_1(uint64_t* COUNT30, DBI32Type* date__d_year, size_t date_size) {
size_t tile_offset = blockIdx.x * TILE_SIZE;
size_t tid = tile_offset + threadIdx.x;
int selection_flags[ITEMS_PER_THREAD];
for (int i=0; i<ITEMS_PER_THREAD; i++) selection_flags[i] = 1;
...
__global__ void count_5(uint64_t* COUNT31, size_t customer_size) {
size_t tile_offset = blockIdx.x * TILE_SIZE;
size_t tid = tile_offset + threadIdx.x;
int selection_flags[ITEMS_PER_THREAD];
for (int i=0; i<ITEMS_PER_THREAD; i++) selection_flags[i] = 1;
...
__global__ void count_20(uint64_t* BUF_28, uint64_t* BUF_29, uint64_t* BUF_30, uint64_t* BUF_31, HASHTABLE_PROBE HT_28, HASHTABLE_PROBE HT_29, HASHTABLE_PROBE HT_30, HASHTABLE_PROBE HT_31, HASHTABLE_INSERT HT_33, DBI32Type* date__d_year, DBI32Type* lineorder__lo_custkey, DBI32Type* lineorder__lo_orderdate, DBI32Type* lineorder__lo_partkey, DBI32Type* lineorder__lo_suppkey, size_t lineorder_size, DBI16Type* part__p_brand1_encoded, DBI16Type* supplier__s_city_encoded) {
size_t tile_offset = blockIdx.x * TILE_SIZE;
size_t tid = tile_offset + threadIdx.x;
int selection_flags[ITEMS_PER_THREAD];
for (int i=0; i<ITEMS_PER_THREAD; i++) selection_flags[i] = 1;
...
count_8<<<std::ceil((float)supplier_size/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(d_COUNT28, d_supplier__s_nation, supplier_size);
uint64_t COUNT28;
...
count_14<<<std::ceil((float)part_size/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(d_COUNT29, d_part__p_category, part_size);
uint64_t COUNT29;
...
main_14<<<std::ceil((float)part_size/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(d_BUF_29, d_BUF_IDX_29, d_HT_29.ref(cuco::insert), d_cycles_per_warp_main_14_join_build_29, d_cycles_per_warp_main_14_selection_13, d_cycles_per_warp_main_14_selection_15, d_cycles_per_warp_main_14_selection_16, d_cycles_per_warp_main_14_selection_17, d_cycles_per_warp_main_14_selection_18, d_part__p_category, d_part__p_partkey, part_size);
...
count_1<<<std::ceil((float)date_size/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(d_COUNT30, d_date__d_year, date_size);
uint64_t COUNT30;
...
main_1<<<std::ceil((float)date_size/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(d_BUF_30, d_BUF_IDX_30, d_HT_30.ref(cuco::insert), d_cycles_per_warp_main_1_join_build_30, d_cycles_per_warp_main_1_selection_0, d_cycles_per_warp_main_1_selection_2, d_cycles_per_warp_main_1_selection_3, d_date__d_datekey, d_date__d_year, date_size);
...
count_5<<<std::ceil((float)customer_size/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(d_COUNT31, customer_size);
uint64_t COUNT31;
...
main_5<<<std::ceil((float)customer_size/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(d_BUF_31, d_BUF_IDX_31, d_HT_31.ref(cuco::insert), d_customer__c_custkey, customer_size, d_cycles_per_warp_main_5_join_build_31, d_cycles_per_warp_main_5_selection_4, d_cycles_per_warp_main_5_selection_6);
