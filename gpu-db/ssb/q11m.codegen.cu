...
main_572ef7b755c0<<<std::ceil((float)lineorder_size/128.), 128>>>(d_BUF_572ef7b8ac20, d_HT_572ef7b45c40.ref(cuco::find), d_HT_572ef7b8ac20.ref(cuco::find), d_aggr0__tmp_attr0, d_lineorder__lo_discount, d_lineorder__lo_extendedprice, d_lineorder__lo_orderdate, d_lineorder__lo_quantity, lineorder_size);
//Materialize count
