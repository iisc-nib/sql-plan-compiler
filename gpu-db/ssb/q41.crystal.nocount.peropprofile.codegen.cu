...
main_4<<<std::ceil((float)customer_size/(float)TILE_SIZE), TB>>>(d_BUF_29, d_BUF_IDX_29, d_HT_29.ref(cuco::insert), d_customer__c_custkey, d_customer__c_region, customer_size, d_cycles_per_warp_main_4_join_build_29, d_cycles_per_warp_main_4_selection_3, d_cycles_per_warp_main_4_selection_5, d_cycles_per_warp_main_4_selection_6, d_cycles_per_warp_main_4_selection_7, d_cycles_per_warp_main_4_selection_8);
...
main_16<<<std::ceil((float)part_size/(float)TILE_SIZE), TB>>>(d_BUF_30, d_BUF_IDX_30, d_HT_30.ref(cuco::insert), d_cycles_per_warp_main_16_join_build_30, d_cycles_per_warp_main_16_selection_15, d_cycles_per_warp_main_16_selection_17, d_cycles_per_warp_main_16_selection_18, d_part__p_mfgr, d_part__p_partkey, part_size);
...
main_1<<<std::ceil((float)date_size/(float)TILE_SIZE), TB>>>(d_BUF_31, d_BUF_IDX_31, d_HT_31.ref(cuco::insert), d_cycles_per_warp_main_1_join_build_31, d_cycles_per_warp_main_1_selection_0, d_cycles_per_warp_main_1_selection_2, d_date__d_datekey, date_size);
...
main_35<<<std::ceil((float)COUNT33/(float)TILE_SIZE), TB>>>(COUNT33, d_MAT34aggr0__tmp_attr0, d_MAT34customer__c_nation_encoded, d_MAT34date__d_year, d_MAT_IDX34, d_aggr0__tmp_attr0, d_KEY_33customer__c_nation_encoded, d_cycles_per_warp_main_35_materialize_34, d_KEY_33date__d_year);
