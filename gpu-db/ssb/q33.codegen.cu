...
count_57e2860408c0<<<std::ceil((float)lineorder_size/32.), 32>>>(d_BUF_57e28603d030, d_BUF_57e286044b50, d_COUNT57e28603cef0, d_HT_57e28603d030.ref(cuco::for_each), d_HT_57e286044b50.ref(cuco::for_each), d_lineorder__lo_custkey, d_lineorder__lo_suppkey, lineorder_size);
...
count_57e286051ac0<<<std::ceil((float)date_size/32.), 32>>>(d_BUF_57e28603cef0, d_HT_57e285ff5ec0.ref(cuco::insert), d_HT_57e28603cef0.ref(cuco::for_each), d_customer__c_city_encoded, d_date__d_datekey, d_date__d_year, date_size, d_supplier__s_city_encoded);
