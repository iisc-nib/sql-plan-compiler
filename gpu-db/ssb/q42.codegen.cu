...
count_64352c889080<<<std::ceil((float)supplier_size/32.), 32>>>(d_COUNT64352c878750, d_supplier__s_region, supplier_size);
...
main_64352c889080<<<std::ceil((float)supplier_size/32.), 32>>>(d_BUF_64352c878750, d_BUF_IDX_64352c878750, d_HT_64352c878750.ref(cuco::insert), d_supplier__s_region, d_supplier__s_suppkey, supplier_size);
//Materialize count
...
count_64352c8210e0<<<std::ceil((float)customer_size/32.), 32>>>(d_COUNT64352c87c300, d_customer__c_region, customer_size);
...
main_64352c8210e0<<<std::ceil((float)customer_size/32.), 32>>>(d_BUF_64352c87c300, d_BUF_IDX_64352c87c300, d_HT_64352c87c300.ref(cuco::insert), d_customer__c_custkey, d_customer__c_region, customer_size);
//Materialize count
...
count_64352c821320<<<std::ceil((float)date_size/32.), 32>>>(d_COUNT64352c859860, d_date__d_year, date_size);
...
main_64352c821320<<<std::ceil((float)date_size/32.), 32>>>(d_BUF_64352c859860, d_BUF_IDX_64352c859860, d_HT_64352c859860.ref(cuco::insert), d_date__d_datekey, d_date__d_year, date_size);
//Materialize count
...
main_64352c88e100<<<std::ceil((float)lineorder_size/32.), 32>>>(d_BUF_64352c859860, d_BUF_64352c876900, d_BUF_64352c878750, d_BUF_64352c87c300, d_BUF_IDX_64352c876900, d_HT_64352c859860.ref(cuco::for_each), d_HT_64352c876900.ref(cuco::insert), d_HT_64352c878750.ref(cuco::for_each), d_HT_64352c87c300.ref(cuco::for_each), d_lineorder__lo_custkey, d_lineorder__lo_orderdate, d_lineorder__lo_partkey, d_lineorder__lo_suppkey, lineorder_size);
//Create aggregation hash table
...
count_64352c88b8a0<<<std::ceil((float)part_size/32.), 32>>>(d_BUF_64352c876900, d_HT_64352c82ff40.ref(cuco::insert), d_HT_64352c876900.ref(cuco::for_each), d_date__d_year, d_part__p_category_encoded, d_part__p_mfgr, d_part__p_partkey, part_size, d_supplier__s_nation_encoded);
...
insertKeys<<<std::ceil((float)COUNT64352c82ff40/32.), 32>>>(raw_keys64352c82ff40, d_HT_64352c82ff40.ref(cuco::insert), COUNT64352c82ff40);
//Aggregate in hashtable
...
main_64352c88b8a0<<<std::ceil((float)part_size/32.), 32>>>(d_BUF_64352c876900, d_HT_64352c82ff40.ref(cuco::find), d_HT_64352c876900.ref(cuco::for_each), d_KEY_64352c82ff40date__d_year, d_KEY_64352c82ff40part__p_category_encoded, d_KEY_64352c82ff40supplier__s_nation_encoded, d_aggr0__tmp_attr0, d_date__d_year, d_lineorder__lo_revenue, d_lineorder__lo_supplycost, d_part__p_category_encoded, d_part__p_mfgr, d_part__p_partkey, part_size, d_supplier__s_nation_encoded);
//Materialize count
...
count_64352c89e1d0<<<std::ceil((float)COUNT64352c82ff40/32.), 32>>>(d_COUNT64352c80fc50, COUNT64352c82ff40);
