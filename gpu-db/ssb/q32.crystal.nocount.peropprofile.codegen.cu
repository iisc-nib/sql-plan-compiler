...
for (int ITEM = 0; ITEM < ITEMS_PER_THREAD && (ITEM*TB + tid < customer_size); ++ITEM) {
if (!selection_flags[ITEM]) continue;
HT_20.insert(cuco::pair{KEY_20[ITEM], ITEM*TB + tid});
BUF_20[(ITEM*TB + tid) * 1 + 0] = ITEM*TB + tid;
}
...
main_1<<<std::ceil((float)customer_size/(float)TILE_SIZE), TB>>>(d_BUF_20, d_BUF_IDX_20, d_HT_20.ref(cuco::insert), d_customer__c_custkey, d_customer__c_nation, customer_size, d_cycles_per_warp_main_1_join_build_20, d_cycles_per_warp_main_1_selection_0, d_cycles_per_warp_main_1_selection_2, d_cycles_per_warp_main_1_selection_3, d_cycles_per_warp_main_1_selection_4, d_cycles_per_warp_main_1_selection_5);
...
main_22<<<std::ceil((float)date_size/(float)TILE_SIZE), TB>>>(d_BUF_27, d_BUF_IDX_27, d_HT_27.ref(cuco::insert), d_cycles_per_warp_main_22_join_build_27, d_cycles_per_warp_main_22_selection_21, d_cycles_per_warp_main_22_selection_23, d_cycles_per_warp_main_22_selection_24, d_cycles_per_warp_main_22_selection_25, d_cycles_per_warp_main_22_selection_26, d_date__d_datekey, d_date__d_year, date_size);
