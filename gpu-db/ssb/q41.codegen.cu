...
count_5efabf2f9580<<<std::ceil((float)supplier_size/32.), 32>>>(d_COUNT5efabf332630, d_supplier__s_region, supplier_size);
...
main_5efabf2f9580<<<std::ceil((float)supplier_size/32.), 32>>>(d_BUF_5efabf332630, d_BUF_IDX_5efabf332630, d_HT_5efabf332630.ref(cuco::insert), d_supplier__s_region, d_supplier__s_suppkey, supplier_size);
//Materialize count
...
count_5efabf2f97c0<<<std::ceil((float)customer_size/32.), 32>>>(d_COUNT5efabf350440, d_customer__c_region, customer_size);
...
main_5efabf2f97c0<<<std::ceil((float)customer_size/32.), 32>>>(d_BUF_5efabf350440, d_BUF_IDX_5efabf350440, d_HT_5efabf350440.ref(cuco::insert), d_customer__c_custkey, d_customer__c_region, customer_size);
//Materialize count
...
count_5efabf362f80<<<std::ceil((float)part_size/32.), 32>>>(d_COUNT5efabf354720, d_part__p_mfgr, part_size);
...
main_5efabf362f80<<<std::ceil((float)part_size/32.), 32>>>(d_BUF_5efabf354720, d_BUF_IDX_5efabf354720, d_HT_5efabf354720.ref(cuco::insert), d_part__p_mfgr, d_part__p_partkey, part_size);
//Materialize count
...
count_5efabf352b40<<<std::ceil((float)date_size/32.), 32>>>(d_COUNT5efabf3547e0, date_size);
...
main_5efabf352b40<<<std::ceil((float)date_size/32.), 32>>>(d_BUF_5efabf3547e0, d_BUF_IDX_5efabf3547e0, d_HT_5efabf3547e0.ref(cuco::insert), d_date__d_datekey, date_size);
//Create aggregation hash table
...
count_5efabf3657e0<<<std::ceil((float)lineorder_size/32.), 32>>>(d_BUF_5efabf332630, d_BUF_5efabf350440, d_BUF_5efabf354720, d_BUF_5efabf3547e0, d_HT_5efabf307cb0.ref(cuco::insert), d_HT_5efabf332630.ref(cuco::for_each), d_HT_5efabf350440.ref(cuco::for_each), d_HT_5efabf354720.ref(cuco::for_each), d_HT_5efabf3547e0.ref(cuco::for_each), d_customer__c_nation_encoded, d_date__d_year, d_lineorder__lo_custkey, d_lineorder__lo_orderdate, d_lineorder__lo_partkey, d_lineorder__lo_suppkey, lineorder_size);
...
insertKeys<<<std::ceil((float)COUNT5efabf307cb0/32.), 32>>>(raw_keys5efabf307cb0, d_HT_5efabf307cb0.ref(cuco::insert), COUNT5efabf307cb0);
//Aggregate in hashtable
...
main_5efabf3657e0<<<std::ceil((float)lineorder_size/32.), 32>>>(d_BUF_5efabf332630, d_BUF_5efabf350440, d_BUF_5efabf354720, d_BUF_5efabf3547e0, d_HT_5efabf307cb0.ref(cuco::find), d_HT_5efabf332630.ref(cuco::for_each), d_HT_5efabf350440.ref(cuco::for_each), d_HT_5efabf354720.ref(cuco::for_each), d_HT_5efabf3547e0.ref(cuco::for_each), d_KEY_5efabf307cb0customer__c_nation_encoded, d_KEY_5efabf307cb0date__d_year, d_aggr0__tmp_attr0, d_customer__c_nation_encoded, d_date__d_year, d_lineorder__lo_custkey, d_lineorder__lo_orderdate, d_lineorder__lo_partkey, d_lineorder__lo_revenue, d_lineorder__lo_suppkey, d_lineorder__lo_supplycost, lineorder_size);
//Materialize count
...
count_5efabf378b50<<<std::ceil((float)COUNT5efabf307cb0/32.), 32>>>(d_COUNT5efabf2e7da0, COUNT5efabf307cb0);
...
main_5efabf378b50<<<std::ceil((float)COUNT5efabf307cb0/32.), 32>>>(COUNT5efabf307cb0, d_MAT5efabf2e7da0aggr0__tmp_attr0, d_MAT5efabf2e7da0customer__c_nation_encoded, d_MAT5efabf2e7da0date__d_year, d_MAT_IDX5efabf2e7da0, d_aggr0__tmp_attr0, d_KEY_5efabf307cb0customer__c_nation_encoded, d_KEY_5efabf307cb0date__d_year);
