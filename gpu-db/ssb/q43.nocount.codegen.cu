...
__global__ void main_9(uint64_t* BUF_6, HASHTABLE_PROBE HT_6, HASHTABLE_FIND HT_8, DBI32Type* KEY_8date__d_year, DBI16Type* KEY_8part__p_brand1_encoded, DBI16Type* KEY_8supplier__s_city_encoded, int* SLOT_COUNT_8, DBDecimalType* aggr0__tmp_attr0, DBI32Type* customer__c_custkey, size_t customer_size, DBI32Type* date__d_year, DBDecimalType* lineorder__lo_revenue, DBDecimalType* lineorder__lo_supplycost, DBI16Type* part__p_brand1_encoded, DBI16Type* supplier__s_city_encoded) {
size_t tid = blockIdx.x * blockDim.x + threadIdx.x;
...
main_9<<<std::ceil((float)customer_size/128.), 128>>>(d_BUF_6, d_HT_6.ref(cuco::for_each), d_HT_8.ref(cuco::insert_and_find), d_KEY_8date__d_year, d_KEY_8part__p_brand1_encoded, d_KEY_8supplier__s_city_encoded, d_SLOT_COUNT_8, d_aggr0__tmp_attr0, d_customer__c_custkey, customer_size, d_date__d_year, d_lineorder__lo_revenue, d_lineorder__lo_supplycost, d_part__p_brand1_encoded, d_supplier__s_city_encoded);
COUNT8 = d_HT_8.size();
