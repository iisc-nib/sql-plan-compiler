...
aggregate_any(&moved_aggr_u_1__ps_partkey[buf_idx_4], reg_partsupp__ps_partkey[ITEM]);
aggregate_any(&moved_aggr_u_2__ps_availqty[buf_idx_4], reg_partsupp__ps_availqty[ITEM]);
...
main_9<<<std::ceil((float)COUNT4/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(COUNT4, d_HT_8.ref(cuco::insert), d_aggr0__tmp_attr0, d_moved_aggr__ps_suppkey, d_moved_aggr_u_1__ps_partkey, d_moved_aggr_u_2__ps_availqty);
