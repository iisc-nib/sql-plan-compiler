...
main_1<<<std::ceil((float)lineitem_size/(float)TILE_SIZE), TB>>>(d_HT_4.ref(cuco::insert), d_cycles_per_warp_main_1_selection_0, d_cycles_per_warp_main_1_semi_join_build_4, d_lineitem__l_commitdate, d_lineitem__l_orderkey, d_lineitem__l_receiptdate, lineitem_size);
...
main_3<<<std::ceil((float)orders_size/(float)TILE_SIZE), TB>>>(d_HT_4.ref(cuco::find), d_HT_5.ref(cuco::insert_and_find), d_KEY_5orders__o_orderpriority_encoded, d_SLOT_COUNT_5, d_aggr0__tmp_attr0, d_cycles_per_warp_main_3_aggregation_5, d_cycles_per_warp_main_3_selection_2, d_cycles_per_warp_main_3_semi_join_probe_4, d_orders__o_orderdate, d_orders__o_orderkey, d_orders__o_orderpriority_encoded, orders_size);
...
main_7<<<std::ceil((float)COUNT5/(float)TILE_SIZE), TB>>>(COUNT5, d_MAT6aggr0__tmp_attr0, d_MAT6orders__o_orderpriority_encoded, d_MAT_IDX6, d_aggr0__tmp_attr0, d_cycles_per_warp_main_7_materialize_6, d_KEY_5orders__o_orderpriority_encoded);
