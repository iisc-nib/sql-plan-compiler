...
//Create aggregation hash table
auto d_HT_0 = cuco::static_map{ (int)5872283*2, cuco::empty_key{(int64_t)-1},cuco::empty_value{(int64_t)-1},thrust::equal_to<int64_t>{},cuco::linear_probing<1, cuco::default_hash_function<int64_t>>() };
count_1<<<std::ceil((float)lineitem_size/32.), 32>>>(d_HT_0.ref(cuco::insert), d_lineitem__l_linestatus, d_lineitem__l_returnflag, d_lineitem__l_shipdate, lineitem_size);
...
insertKeys<<<std::ceil((float)COUNT0/32.), 32>>>(raw_keys0, d_HT_0.ref(cuco::insert), COUNT0);
//Aggregate in hashtable
...
main_1<<<std::ceil((float)lineitem_size/32.), 32>>>(d_HT_0.ref(cuco::find), d_KEY_0lineitem__l_linestatus, d_KEY_0lineitem__l_returnflag, d_aggr0__tmp_attr0, d_aggr0__tmp_attr1, d_aggr0__tmp_attr2, d_aggr0__tmp_attr4, d_aggr0__tmp_attr9, d_aggr_rw__rw0, d_aggr_rw__rw1, d_aggr_rw__rw2, d_aggr_rw__rw3, d_aggr_rw__rw4, d_aggr_rw__rw5, d_lineitem__l_discount, d_lineitem__l_extendedprice, d_lineitem__l_linestatus, d_lineitem__l_quantity, d_lineitem__l_returnflag, d_lineitem__l_shipdate, d_lineitem__l_tax, lineitem_size);
//Materialize count
uint64_t* d_COUNT2;
cudaMalloc(&d_COUNT2, sizeof(uint64_t));
cudaMemset(d_COUNT2, 0, sizeof(uint64_t));
count_3<<<std::ceil((float)COUNT0/32.), 32>>>(COUNT0, d_COUNT2);
uint64_t COUNT2;
...
main_3<<<std::ceil((float)COUNT0/32.), 32>>>(COUNT0, d_MAT2aggr0__tmp_attr0, d_MAT2aggr0__tmp_attr1, d_MAT2aggr0__tmp_attr2, d_MAT2aggr0__tmp_attr4, d_MAT2aggr0__tmp_attr6, d_MAT2aggr0__tmp_attr7, d_MAT2aggr0__tmp_attr8, d_MAT2aggr0__tmp_attr9, d_MAT2lineitem__l_linestatus, d_MAT2lineitem__l_returnflag, d_MAT_IDX2, d_aggr0__tmp_attr0, d_aggr0__tmp_attr1, d_aggr0__tmp_attr2, d_aggr0__tmp_attr4, d_aggr0__tmp_attr9, d_aggr_rw__rw0, d_aggr_rw__rw1, d_aggr_rw__rw2, d_aggr_rw__rw3, d_aggr_rw__rw4, d_aggr_rw__rw5, d_KEY_0lineitem__l_linestatus, d_KEY_0lineitem__l_returnflag);
