...
count_9<<<std::ceil((float)COUNT4/(float)TILE_SIZE), TILE_SIZE/ITEMS_PER_THREAD>>>(COUNT4, d_COUNT8, d_aggr0__tmp_attr0, d_moved_aggr__ps_suppkey, d_moved_aggr_u_1__ps_partkey, d_moved_aggr_u_2__ps_availqty);
uint64_t COUNT8;
