...
main_5<<<std::ceil((float)lineitem_size/128.), 128>>>(d_BUF_2, d_HT_2.ref(cuco::for_each), d_HT_4.ref(cuco::insert_and_find), d_KEY_4lineitem__l_orderkey, d_SLOT_COUNT_4, d_aggr0__tmp_attr0, d_aggr__o_orderdate, d_aggr__o_shippriority, d_lineitem__l_discount, d_lineitem__l_extendedprice, d_lineitem__l_orderkey, d_lineitem__l_shipdate, lineitem_size, d_orders__o_orderdate, d_orders__o_shippriority);
COUNT4 = d_HT_4.size();
