...
main_3<<<std::ceil((float)orders_size/128.), 128>>>(d_BUF_0, d_HT_0.ref(cuco::for_each), d_HT_2.ref(cuco::insert_and_find), d_KEY_2customer__c_custkey, d_SLOT_COUNT_2, d_aggr0__tmp_attr0, d_customer__c_custkey, d_orders__o_custkey, d_orders__o_orderkey, orders_size);
COUNT2 = d_HT_2.size();
